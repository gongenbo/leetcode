<!-- GFM-TOC -->
* [167. 有序数组的 Two Sum](#167-有序数组的-two-sum) easy
* [633. 两数平方和](#633-两数平方和)  easy
* [345. 反转字符串中的元音字符](#345-反转字符串中的元音字符)   easy
* [680. 回文字符串](#680-回文字符串) easy
* [88. 归并两个有序数组](#88-归并两个有序数组)  easy 
* [141. 判断链表是否存在环](#141-判断链表是否存在环)  easy
* [524. 最长子序列](#524-最长子序列) medium
<!-- GFM-TOC -->
...
string findLongestWord(string s, vector<string>& d) {
    ...
    for(int i = 0; i < d.size(); i++){
        string substr = d[i];
        //获取长度最长且字典顺序最小的字符串
        if(longword.size() > substr.size() ||  longword.size() == substr.size() && longword.compare(substr) <0){
            continue;
        }
        if(isMath(s,substr)){
            longword = substr;
...
bool isMath(string s, string substr){
    int i = 0, j = 0;
